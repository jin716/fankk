...
#mainFrame{
	...
	<script type="text/javascript">
		...
		function getMap(val){
			...
			document.getElementById("mainFrame").src="../../map.do?type=block&width=500&height=300&block="+val;
		}
	</script>
  </head>
  <body>
...
<div class="bcontentlist">
  	...
  	<table width="600" style="margin-top:20px;border-right:1px solid #f3f3f3;border-top:1px solid #f3f3f3" class="order success-order xcard">            
			...
			<tr class="order-item">
				...
				<td>
					<textarea rows="3" cols="20" name="storeAddrName" id="storeAddrName" value="${store.storeAddrName}"></textarea>			
				</td>
            	<td class=order-hd>短信手机</td><td><input id="storeMobile" name="storeMobile" type="text"/></td>
            </tr>
            <tr>
            	<td class=order-hd>起送价格</td>
				<td width="200">
					<input type="text" name="storeLowCost" value="${store.storeSendCost}">
				</td>
			...
			<tr id="mainFrame_tr_2" class="order-item">
            	<td class=order-hd>NTU经度</td><td><input id="ntulongitude" name="ntulongitude" type="text"/></td>
            	<td class=order-hd>NTU纬度</td><td><input id="ntulatidute" name="ntulatidute" type="text"/></td>
			</tr>

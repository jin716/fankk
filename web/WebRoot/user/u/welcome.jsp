...
<link rel="stylesheet" href="../../css/topnav/common_v2.css">
	<div id="topnav">
        <ul class="guid">
            <li class="selected"><a href="javascript:void(0)"><span>我是顾客</span></a></li>
        </ul>
...
<div id="sidebar_left">
                ...
                <div class="system_menu1" id="menu_001">
                    <ul class="" style="">
                    	<li class="">         
                            <a href="welcome.do?action=userInfo" target="mainFrame">基本资料</a>
                        </li>
                        <li class="">         
                            <a href="welcome.do?action=orderList" target="mainFrame">订单查询</a>
                        </li>
                        <li class="">         
                            <a href="welcome.do?action=jifen" target="mainFrame">积分兑换</a>
                        </li>
                        <li class="">         
                            <a href="welcome.do?action=userInfoEdit" target="mainFrame">常用地址设置</a>
                        </li>
                        <li class="">         

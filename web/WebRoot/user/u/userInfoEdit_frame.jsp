...
<div class="main" id="maindiv">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr errorclass="list_error exception">
              <th>常用地址一:</th>
              <td><input type="text" name="userAddr1" value="${c_user.userAddr1}"/></td>              
            </tr>
            <tr errorclass="list_error exception">
              <th>常用地址二:</th>
              <td><input type="text" name="userAddr2" value="${c_user.userAddr2}"/></td>              
            </tr>
             <tr errorclass="list_error exception">
              <th>常用地址三:</th>
              <td><input type="text" name="userAddr3" value="${c_user.userAddr3}"/></td>              
            </tr>
             <tr errorclass="list_error exception">
              <th></th>

...
<link rel="stylesheet" href="../css/topnav/common_v2.css">
	<div id="topnav">
        <ul class="guid">
            <li class="selected"><a href="javascript:void(0)"><span>客服人员</span></a></li>
        </ul>
...
<div id="sidebar_left">
            	<span style="font-weight:bold;background-image:url(../../images/admin_bg_statebar.png);background-repeat:repeat-x;display:block;margin:0;padding-top:4px;text-align:center;height:26px;font-size:14px;">饭快快支撑系统</span>
                
                <div class="system_menu1" id="menu_001">
                    <ul class="" style="">
                    	<li class="">         
                            <a href="service.do?action=latestOrder" target="mainFrame">最新订单</a>
                        </li>
                        <li class="">         
                            <a href="service.do?action=historyOrder" target="mainFrame">历史订单</a>
                        </li>   
                        <li class="">         
                            <a href="service.do?action=idOrder" target="mainFrame">订单查询</a>
                        </li>           
                    </ul>
                </div>
            </div>
            ...
            <div id="main_ad">
                <iframe id="mainFrame" name="mainFrame"  frameborder="no" border="0" scrolling="no" src="service.do?action=${url}">
                </iframe>
            </div>

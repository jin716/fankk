          ...
          <div id="left_comment">
            ...
            <div class="comment">
                ...
                <div class="pagination" style="width:700px;margin-top:16px;">
                    <ul>
                    <li><a href="getComment.do?type=comment&store=${store.storeId}&page=${page.pre}">上一页</a></li>
                    <c:forEach items="${page.pageList}" var="pageNo" varStatus="status">
                    	...
                    	<c:if test="${pageNo != '-1'}"><c:if test="${pageNo != page.cur}"><li><a href="getComment.do?type=comment&store=${store.storeId}&page=${pageNo}">${pageNo}</a></li></c:if></c:if>
                    </c:forEach>
                    <li><a href="getComment.do?type=comment&store=${store.storeId}&page=${page.next}">下一页</a></li>
                    </ul>
                </div>
            </div>
